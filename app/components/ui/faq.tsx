...
const FAQ: React.FC = () => {
  ...
  const handleToggle = (idx: number, ref: React.RefObject<HTMLDivElement>, maxHeight: string) => {
    return tab === idx ? maxHeight : '0px';
  };
            ...
            <div key={idx} className="space-y-3">
              <div className={`relative transition-all duration-700 border rounded-xl hover:shadow-2xl`}>
                ...
                <div
                  ...
                  style={{
                    transition: 'all 0.7s',
                    maxHeight: handleToggle(idx + 1, ref, maxHeight),
                  }}
