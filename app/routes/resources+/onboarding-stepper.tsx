						...
						>
							<div className="h-full overflow-y-auto bg-accent px-3 py-4">
								...
								<div className="overflow-y-auto py-4">
									<ol
										onClick={dismissModal}
										className="dark:border-night-400 relative ml-5 border-l border-gray-200 text-gray-500 dark:text-gray-400"
									>
										<Link to={`/users/${user?.username}/jobs/new`}>
											<li className="mb-10 ml-6">
												{gettingStartedProgress?.hasSavedJob ? (
													...
													<span className="dark:bg-night-400 absolute -left-4 flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 ring-4 ring-white dark:ring-gray-900">
														<svg
															xmlns="http://www.w3.org/2000/svg"
															height="1em"
															viewBox="0 0 512 512"
