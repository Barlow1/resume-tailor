...
CREATE TABLE "new_GettingStartedProgress" (
    ...
    "quickTailorDownloadCount" INTEGER NOT NULL DEFAULT 0,
...
INSERT INTO "new_GettingStartedProgress" ("analysisCount", "createdAt", "downloadCount", "generateCount", "hasGeneratedResume", "hasSavedJob", "hasSavedResume", "hasTailoredResume", "id", "outreachCount", "ownerId", "tailorCount", "updatedAt") SELECT "analysisCount", "createdAt", "downloadCount", "generateCount", "hasGeneratedResume", "hasSavedJob", "hasSavedResume", "hasTailoredResume", "id", "outreachCount", "ownerId", "tailorCount", "updatedAt" FROM "GettingStartedProgress";
